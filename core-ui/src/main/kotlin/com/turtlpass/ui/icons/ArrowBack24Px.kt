...
val ArrowBack24Px: ImageVector
    get() {
        if (_ArrowBack24Px != null) {
            return _ArrowBack24Px!!
        }
        _ArrowBack24Px = ImageVector.Builder(
            name = "ArrowBack24Px",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
...
private fun Preview() {
    AppTheme {
        Icon(imageVector = ArrowBack24Px, contentDescription = null)
    }
}
